    ...
    <>
      ...
      <ParallaxContent scrollY={scrollY}>
        <section className={`min-h-screen flex items-center justify-center relative hero-section ${openSans.className}`}>
          ...
          <div className="container mx-auto px-4 py-16 content-wrapper">
            {/* Add navigation buttons */}
            <div className="absolute top-2 left-[60%] transform -translate-x-1/2 z-50 flex gap-20">
            ...
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
              {/* Image section */}
              <div className="md:sticky md:top-8 h-fit order-1 md:order-none relative flex justify-center items-center min-h-[600px]">
                <div 
                  className="animate-float relative z-10 max-w-[500px]"
                  style={{ 
                ...
                >
                  <img
                    src="/meee.PNG"
                    alt="Sai Srinivas"
                    className="w-full h-auto max-h-[550px] object-contain rounded-3xl"
                  />
                </div>
              </div>
              ...
              {/* Content section */}
              <div 
                className="space-y-6 relative z-20 max-w-xl text-container"
                style={{ 
                  transform: `translateY(${scrollY * 0.15}px)`,
                }}
              >
                <div className="space-y-4">
                  <div className="text-sm md:text-base font-semibold tracking-wide px-5 py-3 inline-block rounded-xl animate-fade-in-right">
                    <span 
                  ...
                  <div className="space-y-2">
                    <h1 className="text-3xl md:text-5xl font-bold text-gray-900 tracking-tight leading-none animate-fade-in-up group">
                    ...
                    <div className="space-y-2">
                      <div 
                        className="relative text-2xl md:text-4xl font-bold tracking-tight whitespace-nowrap inline-block min-h-[50px] leading-tight"
                        style={{
                          background: 'linear-gradient(to right, #3f2b96, #a8c0ff)',
                          backgroundSize: '200% auto',
                          backgroundClip: 'text',
                      ...
                      <h2 className="text-xl md:text-2xl text-gray-800 tracking-tight animate-fade-in-up delay-300 leading-snug">
                ...
                <p className="text-base text-gray-700 tracking-wide animate-fade-in-up delay-500 leading-relaxed max-w-2xl">
                ...
                <div className="flex gap-6 pt-4 animate-fade-in-up delay-1000">
                  <SocialIcon 
                    type="github"
