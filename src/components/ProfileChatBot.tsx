...
const ProfileChatBot = () => {
  ...
  const generateResponse = (query: string, userName: string = ''): { text: string; links?: Array<{ text: string; url: string; type: string }> } => {
    ...
    if (hasKeyword(['skills', 'programming', 'languages', 'technologies', 'tech', 'coding', 'code', 'program', 'skill', 'expertise', 'knows', 'can do'])) {
      return {
        text: "Sai has 3+ years of comprehensive technical expertise as a Generative AI Engineer across multiple domains. His core expertise includes:\n\nGenerative AI & LLMs: OpenAI, Gemini, LLaMA, AWS Bedrock, Snowflake Cortex, Conversational AI, Virtual Assistants, Agentic Frameworks, Model Deployment, Monitoring & Drift Detection, Synthetic Data Generation\n\nProgramming & Development: Python, FastAPI, Flask, Streamlit, SQL, API Integration, Microservices, CI/CD, Docker\n\nData & Analytics: Data Cleaning, Bias Detection, Text Classification, Feature Engineering, Predictive Modeling, Knowledge Extraction, Recommendation Systems\n\nVisualization & Tools: Tableau, Power BI, Salesforce CRM Analytics, Airflow, Power Automate, REST APIs, AWS, GCP, Azure Cloud\n\nHis experience spans enterprise-level GenAI implementations with measurable business impact including 35% efficiency improvements and 40% error reduction."
      };
    }
    ...
    // Gen AI role suitability (MUST BE FIRST)
    if (hasKeyword(['gen ai', 'generative ai', 'genai', 'generative artificial intelligence', 'llm', 'large language model', 'chatgpt', 'openai', 'gemini', 'llama', 'ai engineer', 'ai developer', 'generative ai engineer', 'generative ai developer', 'ai ml engineer', 'ai ml developer', 'prompt engineer', 'prompt engineering', 'conversational ai', 'virtual assistant', 'ai chatbot', 'ai agent', 'ai automation', 'ai integration', 'ai implementation', 'ai deployment', 'ai monitoring', 'ai drift', 'ai performance', 'ai model', 'ai framework', 'ai platform', 'ai solution', 'ai system', 'ai application', 'ai tool', 'ai service', 'ai product', 'ai feature', 'ai capability', 'ai technology', 'ai innovation', 'ai advancement', 'ai development', 'ai research', 'ai analysis', 'ai optimization', 'ai enhancement', 'ai improvement', 'ai scaling', 'ai production', 'ai enterprise', 'ai business', 'ai commercial', 'ai industrial', 'ai professional', 'ai career', 'ai role', 'ai position', 'ai job', 'ai opportunity', 'ai work', 'ai employment', 'ai hiring', 'ai recruitment', 'ai talent', 'ai expertise', 'ai skill', 'ai knowledge', 'ai experience', 'ai background', 'ai qualification', 'ai credential', 'ai certification', 'ai training', 'ai education', 'ai degree', 'ai program', 'ai course', 'ai learning', 'ai study', 'ai research', 'ai project', 'ai portfolio', 'ai work', 'ai achievement', 'ai success', 'ai result', 'ai impact', 'ai value', 'ai benefit', 'ai advantage', 'ai strength', 'ai capability', 'ai potential', 'ai future', 'ai trend', 'ai market', 'ai industry', 'ai sector', 'ai domain', 'ai field', 'ai area', 'ai specialization', 'ai focus', 'ai interest', 'ai passion', 'ai dedication', 'ai commitment', 'ai motivation', 'ai drive', 'ai ambition', 'ai goal', 'ai objective', 'ai target', 'ai vision', 'ai mission', 'ai purpose', 'ai reason', 'ai why', 'ai how', 'ai what', 'ai when', 'ai where', 'ai who', 'ai which', 'ai suitable', 'ai fit', 'ai match', 'ai qualified', 'ai eligible', 'ai good', 'ai excellent', 'ai perfect', 'ai ideal', 'ai best', 'ai top', 'ai leading', 'ai advanced', 'ai cutting-edge', 'ai state-of-the-art', 'ai innovative', 'ai creative', 'ai original', 'ai unique', 'ai special', 'ai exceptional', 'ai outstanding', 'ai remarkable', 'ai impressive', 'ai amazing', 'ai incredible', 'ai fantastic', 'ai wonderful', 'ai great', 'ai awesome', 'ai superb', 'ai excellent', 'ai perfect', 'ai ideal', 'ai best', 'ai top', 'ai leading', 'ai advanced', 'ai cutting-edge', 'ai state-of-the-art', 'ai innovative', 'ai creative', 'ai original', 'ai unique', 'ai special', 'ai exceptional', 'ai outstanding', 'ai remarkable', 'ai impressive', 'ai amazing', 'ai incredible', 'ai fantastic', 'ai wonderful', 'ai great', 'ai awesome', 'ai superb'])) {
      return {
        text: "**Yes, Sai is well-suited for a Gen AI role!**\n\n**Direct Gen AI Experience:**\n• **Bloomberg (Jul 2024–Present)**: Generative AI Engineer\n  - Built LLM features for financial data products\n  - Prompt engineering templates\n  - Python APIs linking LLM outputs to analyst platforms (40% error reduction)\n  - Monitoring for latency, drift, accuracy, and performance\n  - Evaluated proprietary vs. open-source LLMs (Gemini, LLaMA, GPT)\n\n• **Findem Inc. (Jun 2021–Dec 2023)**: Generative AI Engineer\n  - GenAI recruitment tools (35% efficiency gain)\n  - Conversational chatbots with LLMs\n  - Integrated GenAI APIs (OpenAI, Gemini)\n  - Synthetic datasets for LLM fine-tuning\n  - AI dashboards for hiring decisions\n\n**Technical Skills:**\n• **LLMs**: OpenAI, Gemini, LLaMA, AWS Bedrock, Snowflake Cortex\n• **Frameworks**: Conversational AI, virtual assistants, agentic frameworks\n• **Deployment**: Model deployment, monitoring, drift detection\n• **Data**: Synthetic data generation, bias detection, text classification\n• **Programming**: Python, FastAPI, API integration, microservices\n\n**Education:**\n• **MS Data Science, NJIT (May 2025)**: ML, deep learning, AI, prompt engineering\n• **BTech Computer Science**: Strong CS foundation\n\n**Measurable Impact:**\n• 35% efficiency improvements\n• 40% error reduction\n• 30% faster feature development\n• 25% faster decision-making\n• 1M+ data records processed for ML training\n\n**Current Status:**\n• F1 OPT EAD starting Aug 16, 2025\n• Actively seeking Gen AI roles\n• Based in Newark, NJ\n• Available for US opportunities\n\n**Why He Fits:**\n1. 3+ years of direct Gen AI experience\n2. Enterprise implementations at Bloomberg and Findem\n3. Full-stack skills from data to deployment\n4. Track record of measurable business impact\n5. Strong academic background in data science and AI\n6. Authorized to work in the US\n\n**Recommendation**: Strong candidate for Gen AI roles. His experience, skills, and results align well with current market needs."
      };
    }
